...
**VAE Reconstructions (d=2):**

![VAE Reconstructions](Figure_1.png)

*Figure: Original images (top row) vs VAE reconstructions (bottom row) with latent dimension d=2*
...
**2D Latent Space Visualization (d=2):**

![2D Latent Space](Figure_2.png)

*Figure: 2D latent space visualization colored by digit labels (d=2)*
...
![Generated Samples](Figure_3.png)

*Figure: Samples generated by sampling z ~ N(0,I) and decoding (d=2)*
...
![Latent Interpolation](Figure_4.png)

*Figure: Smooth interpolation between two digits in latent space*

## Architecture

![VAE Architecture](vae_diagram.png)

*Figure: Variational Autoencoder architecture diagram*
...
**Training Curves:**
![Training Curves](Figure_5.png)

*Figure: VAE training curves showing total loss, reconstruction loss, and KL divergence*

**Reconstruction Comparison:**
![Reconstruction Comparison](Figure_1.png)

*Figure: VAE reconstruction quality comparison*
...
![Latent Space 2D](Figure_2.png)

*Figure: 2D latent space structure visualization*
...
**Latent Dimension Ablation (d=16):**

![VAE d=16 Reconstructions](16/Figure_1.png)

*Figure: VAE reconstructions with latent dimension d=16*

![VAE d=16 Latent Space](16/Figure_2.png)

*Figure: PCA projection of 16D latent space to 2D*

![VAE d=16 Generated Samples](16/Figure_3.png)

*Figure: Generated samples with d=16*
